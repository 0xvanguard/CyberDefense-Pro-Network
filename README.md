...
[![Para todos los niveles](https://img.shields.io/badge/para-todos%20los%20niveles-teal?style=flat-square)](./RUTAS.md)
[![Laboratorios Docker](https://img.shields.io/badge/labs-Docker%20reproducibles-blue?style=flat-square)](./04-LABORATORIOS/)
[![IA Copiloto](https://img.shields.io/badge/copiloto-Claude%20%7C%20Perplexity-purple?style=flat-square)](./docs/USANDO-IA.md)
[![Marcos de Referencia](https://img.shields.io/badge/marcos-MITRE%20%7C%20OWASP%20%7C%20NIST-red?style=flat-square)](#-marcos-de-referencia)
[![Licencia](https://img.shields.io/badge/uso-educativo%20%7C%20%C3%A9tico-green?style=flat-square)](#%EF%B8%8F-aviso-legal-y-%C3%A9tico)
[![Colombia](https://img.shields.io/badge/origen-Colombia-yellow?style=flat-square)](https://github.com/0xvanguard)
...
**Una plataforma de estudio gratuita de ciberseguridad y seguridad de la información en español** — no es un volcado de apuntes, no es una lista de herramientas, sino un **sistema de entrenamiento** diseñado para llevarte de cero a un perfil profesional técnico.
...
## 🚀 ¿Por qué esta plataforma es del futuro?
...
Esta plataforma nace precisamente para atacar ese problema desde el ángulo contrario al modelo tradicional:

- **No pagas matrícula, pagas esfuerzo**: todo el contenido es abierto, pero cada módulo exige laboratorio, evidencia y entregable concreto para tu portafolio.
- **No coleccionas diapositivas, coleccionas prácticas reproducibles**: cada módulo importante termina en un lab Docker, un writeup, un script o un pipeline que puedes volver a levantar en minutos.
...
Esta plataforma se construye con una visión de **10 años**, no de un semestre:
...
Además de las rutas tradicionales de Red Team, Blue Team y DevSecOps, esta plataforma ofrece una **especialización única en español** en MLSecOps y seguridad de modelos de lenguaje (LLM).
...
|---|---|---|---|
| 🟢 **Fundamentos** | Sin experiencia previa | 4–6 semanas | [Ver ruta](./RUTAS.md#-ruta-1--fundamentos) |
| 🔴 **Red Team / Ofensiva** | Conoces Linux y redes | 3–4 meses | [Ver ruta](./RUTAS.md#-ruta-2--red-team--seguridad-ofensiva) |
| 🔵 **Blue Team / Defensa** | Conoces sistemas y logs | 3–4 meses | [Ver ruta](./RUTAS.md#-ruta-3--blue-team--defensa) |
| ⚙️ **DevSecOps** | Sabes programar | 2–3 meses | [Ver ruta](./RUTAS.md#%EF%B8%8F-ruta-4--devsecops) |
| 🤖 **IA Aplicada** | Conoces Python básico | 2–3 meses | [Ver ruta](./RUTAS.md#-ruta-5--ia-aplicada-a-seguridad) |

> 📍 **¿No sabes por dónde empezar?** → Empieza con la [🟢 Ruta de Fundamentos](./RUTAS.md#-ruta-1--fundamentos) sin importar tu nivel.
...
│
├── 🔴 01-CIBERSEGURIDAD/               ← Área: Seguridad Ofensiva
...
│   └── 08-criptografia/
│
├── 🔵 02-SEGURIDAD-INFORMACION/        ← Área: Defensa y Gobernanza
│   ├── 01-gestion-riesgos/
...
│
├── 🤖 03-IA-AGENTES-HERRAMIENTAS/      ← Área: IA y Automatización
│   ├── 01-agentes-osint/
│   ├── 02-agentes-pentest/
│   ├── 03-llm-security/
...
|---|---|---|---|
| [`ctf-writeups/`](./04-LABORATORIOS/ctf-writeups/) | Writeups documentados | Todos | No requerido |
| [`htb-thm/`](./04-LABORATORIOS/htb-thm/) | Máquinas reales | Intermedio+ | No requerido |
| [`labs-propios/`](./04-LABORATORIOS/labs-propios/) | Entornos vulnerables creados aquí | Principiante+ | ✅ Sí |
| [`docker-labs/`](./04-LABORATORIOS/docker-labs/) | Docker Compose reproducibles | Todos | ✅ Sí |
...
| Recurso | Contenido |
|---|---|
| [`cheatsheets/`](./05-RECURSOS/cheatsheets/) | Comandos frecuentes por herramienta |
| [`certificaciones/`](./05-RECURSOS/certificaciones/) | Rutas: eJPT → Security+ → OSCP → CEH |
| [`libros/`](./05-RECURSOS/libros/) | Resúmenes y notas de lectura técnica |
| [`cursos-recomendados/`](./05-RECURSOS/cursos-recomendados/) | Plataformas y cursos gratuitos validados |

---

## 🗂️ Construye tu Portafolio

Cada módulo que completes genera un **entregable publicable**. Guía completa en [`PORTAFOLIO.md`](./PORTAFOLIO.md).
...
Esta plataforma usa **Claude** y **Perplexity** como herramientas de soporte activo — no para hacer trampa, sino para aprender más rápido y mejor. Guía completa en [`docs/USANDO-IA.md`](./docs/USANDO-IA.md).
...
- **Tú** → Eres el editor técnico final: el criterio, la ética y la responsabilidad son tuyos.

---

## 🎯 Marcos de Referencia

| Marco | Uso en esta plataforma |
|---|---|
...
1. Lee [`RUTAS.md`](./RUTAS.md) y elige tu camino.
2. Revisa [`MODULOS.md`](./MODULOS.md) para ver todos los módulos con duración y proyectos.
3. Clona el repositorio e ingresa a tu carpeta de primer módulo.
4. Completa la práctica y publica tu entregable → [`PORTAFOLIO.md`](./PORTAFOLIO.md).

---

## 🤝 Contribuir

¿Quieres contribuir labs, cheatsheets, writeups o módulos? Lee [`CONTRIBUIR.md`](./CONTRIBUIR.md).

Toda contribución aprobada se convierte en una entrada de portafolio de código abierto para quien la crea.
...
Estudiante de Seguridad de la Información en Politécnico Grancolombiano · Técnico en Sistemas · entrenándome activamente hacia **Purple Team Engineer (Ofensiva + Defensiva) y DevSecOps**.

Stack actual: Python · Docker · Wazuh · Nmap · MITRE ATT&CK · Anthropic API · Kotlin (Android).

[![LinkedIn](https://img.shields.io/badge/LinkedIn-John%20Sebastian%20Camargo-blue?style=flat-square&logo=linkedin)](https://www.linkedin.com/in/jscamargo-cyber/)
[![GitHub](https://img.shields.io/badge/GitHub-%400xvanguard-black?style=flat-square&logo=github)](https://github.com/0xvanguard)
...
**[⬆ Volver al inicio](#plataforma-de-estudio-de-ciberseguridad-y-seguridad-de-la-información)** · **[🗺️ Ver Rutas](./RUTAS.md)** · **[📋 Ver Módulos](./MODULOS.md)** · **[🗂️ Mi Portafolio](./PORTAFOLIO.md)**
